...
//         console.log("CandidatesSnapshot", candidatesSnapshot);
//         setCandidates(pollData.candidates || candidatesData);
...
//   ) => {
//     console.log("Selected value:", event.target.value); // Add this debug line
    ...
    const fetchPollData = async () => {
      ...
      try {
        ...
        const candidates = pollData.candidates.map(
          (cand: any, idx: number) => ({
            id: idx + 1, // or use any id-generation logic you like
                  ...
                  >
                    <CardContent>
                      <FormControlLabel
                        value={candidate.id}
                        control={
                          <Radio checked={selectedCandidate === candidate.id} />
                        }
                        label={
                          <Box>
                            <Typography variant="h6">
